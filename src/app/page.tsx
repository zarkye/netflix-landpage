    ...
    return (
        <Box position="relative" w="100%" minH="100vh" bg="black" overflowX="hidden">
            ...
            <Box position="relative" w="100%" h="100vh">
                ...
                >
                    <Heading fontSize={{ base: "32px", md: "48px", lg: "62px" }} fontWeight="black" lineHeight={{ base: "1.2", lg: "80px" }} marginBottom="24px" textWrap="balance" fontFamily="/publc" letterSpacing="tighter" marginTop="32px">
            ...
            <Box position="relative" zIndex={50} w="100%" pb="100px" px={{ base: "140px", xl: "355px" }}>
                <Text fontSize="32px" fontWeight="bold" color="white" mt="20px" mb="16px">
                    Em alta
                </Text>

                <Box position="relative" w="100%" h="100%" marginTop="-4px" zIndex={50}>

                    <Flex
                        position="absolute" left={0} top={0} bottom={0} w="40px" bg="black" zIndex={10} align="center" justify="center" cursor="pointer"
                        onClick={() => scroll("left")}
                        _hover={{ bg: "black", color: "white" }} color="gray.300"


                        opacity={showLeftBtn ? 1 : 0}
                        visibility={showLeftBtn ? "visible" : "hidden"}
                        transform={showLeftBtn ? "translateX(0)" : "translateX(-100%)"}
                    ...
                    >
                        {cards.map((card) => (
                            <Box key={card.numero} flexShrink={0} minW="max-content">
                                <NetflixCard numero={card.numero} img={card.img} alt={`Card ${card.titulo}`} />
                            </Box>
                        ))}
                    </HStack>

                    <Flex
                        position="absolute" right={0} top={0} bottom={0} w="40px" bg="black" zIndex={10} align="center" justify="center" cursor="pointer"
                        ...
                        transform={showRightBtn ? "translateX(0)" : "translateX(100%)"} // Desliza para a direita
